...
/*
	M1tch's Zelda quest, quest decrypter/password remover.			** little endian only **
	Being released Jan 2020 due to ZC's open source movement.
	For better understanding old ZC encryption methods.
*/

// It's not very pretty; I was trying to put everything in one readable file, and C just felt faster.
...
#if __STDC_VERSION__ < 199901L						// I'm OCD with this stuff...
...
#ifdef _WIN32										// Screw you Microsoft.
#	include <io.h>
#	pragma warning(disable: 4996)					// I really don't care.
#	define open		_open							// REALLY? Why... WHY?
#	define read		_read
#	define write	_write
#	define close	_close
#endif
